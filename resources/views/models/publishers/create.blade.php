...
<div class="container">
    ...
    <form id='publisherCreateForm' name='publisherCreateForm' class="form-group">
        <label for="nameInput">Name: </label>
        <input type="text" id="nameInput" name="name" class="form-control"/>
        <br/>
        <input type="submit" id="submit" name="submit" value="Create Publisher" class="btn btn-primary">
    </form>
        ...
        $(document).ready(function () {
            $('#submit').click(function (e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    dataType: 'json',
                    data: $('#publisherCreateForm').serialize(),
                    success: function (result) {
                        $('#publisherCreateForm').trigger('reset');
                        $('.alert-danger').hide();
                        $('.alert-success').show();
